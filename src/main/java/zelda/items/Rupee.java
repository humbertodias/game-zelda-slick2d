...
public class Rupee extends GObject {
    ...
    private final static String[] rupeeAnimation = {
        "rupee1", "rupee2", "rupee3", "rupee1", "rupee1", "rupee1", "rupee1", "rupee1", "rupee1", "rupee1", "rupee1",
        "rupee1", "rupee1", "rupee1", "rupee1", "rupee1", "rupee1", "rupee1", "rupee1", "rupee1", "rupee1", "rupee1"
    };
