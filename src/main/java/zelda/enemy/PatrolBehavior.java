...
public class PatrolBehavior extends Behavior {
    ...
    public void behave() {
        ...
        switch (soldier.getDirection()) {
            case UP:
                int[] evxposup = {
                    soldier.getX(), soldier.getX() - 30, soldier.getX() - 20, soldier.getX() + 35, soldier.getX() + 45,
                    soldier.getX() + 15
                };
                int[] evyposup = {
                    soldier.getY(), soldier.getY() - 40, soldier.getY() - 50, soldier.getY() - 50, soldier.getY() - 40,
                    soldier.getY()
                };
            ...
            case DOWN:
                ...
                int[] evyposdown = {
                    soldier.getY() + soldier.getHeight(), soldier.getY() + soldier.getHeight() + 40,
            ...
            case LEFT:
                int[] evxposleft = {
                    soldier.getX(), soldier.getX() - 40, soldier.getX() - 50, soldier.getX() - 50, soldier.getX() - 40,
                    soldier.getX()
                };
                int[] evyposleft = {
                    soldier.getY() + 20, soldier.getY() + 50, soldier.getY() + 40, soldier.getY() - 15,
                    soldier.getY() - 25, soldier.getY() + 5
                };
            ...
            case RIGHT:
                int[] evxposright = {
                    soldier.getX() + soldier.getWidth(), soldier.getX() + soldier.getWidth() + 40,
