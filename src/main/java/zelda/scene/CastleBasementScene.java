...
public class CastleBasementScene extends ZeldaScene {
    ...
    private final Polygon wall1, wall2, wall3, wall4, wall5, wall6, wall7, block1, block2, block3;

    private final Rectangle warpExit = new Rectangle(160, 91, 16, 16);
    ...
    public CastleBasementScene(Game game, String entrance) {
        ...
        int[] wxpos1 = {
            752, 752, 709, 709, 748, 748, 554, 590
        };
        int[] wypos1 = {
            59, 77, 77, 217, 217, 312, 312, 69
        };

        wall1 = new Polygon(wxpos1, wypos1, wypos1.length);

        int[] wxpos2 = {
            554, 554, 584, 593, 708, 708, 578, 578, 664, 671, 646, 646, 736, 736, 807, 807, 441, 439
        };
        int[] wypos2 = {
            313, 334, 334, 341, 341, 369, 369, 405, 407, 574, 575, 702, 701, 827, 827, 902, 902, 600
        };

        wall2 = new Polygon(wxpos2, wypos2, wypos2.length);

        int[] wxpos3 = {
            854, 783, 783, 825, 825, 788, 787, 823, 823, 776, 775, 737, 736, 777, 776, 783, 783, 706, 706, 799, 799,
            792, 791, 799, 799, 763, 764, 868, 868, 909
        };
        int[] wypos3 = {
            38, 57, 77, 78, 215, 218, 311, 312, 333, 334, 341, 341, 372, 369, 399, 400, 468, 471, 573, 576, 622, 623,
            655, 656, 701, 703, 778, 775, 930, 926
        };

        wall3 = new Polygon(wxpos3, wypos3, wypos3.length);

        int[] wxpos4 = {
            868, 399, 399, 179, 177, 98, 98
        };
        int[] wypos4 = {
            930, 934, 808, 801, 790, 790, 934
        };

        wall4 = new Polygon(wxpos4, wypos4, wypos4.length);

        int[] wxpos5 = {
            437, 264, 264, 248, 248, 153,
        };
        int[] wypos5 = {
            678, 678, 748, 748, 680, 678,
        };

        wall5 = new Polygon(wxpos5, wypos5, wypos5.length);

        int[] bxpos = {
            437, 264, 264, 248, 248, 153, 153, 184, 184, 327, 334, 338, 431, 434, 448
        };
        int[] bypos = {
            678, 678, 748, 748, 680, 678, 439, 439, 411, 411, 442, 438, 439, 424, 424
        };

        block1 = new Polygon(bxpos, bypos, bypos.length);

        int[] wxpos6 = {
            97, 97, 73, 73, 114, 111, 145, 33
        };
        int[] wypos6 = {
            789, 439, 439, 375, 375, 119, 113, 113
        };
        ...
        int[] wxpos7 = {
            447, 447, 432, 432, 417, 417, 352, 352, 337, 337, 323, 323, 187, 192, 145, 145, 189, 189, 148, 148, 148,
            189, 447
        };
        int[] wypos7 = {
            421, 368, 368, 359, 359, 336, 338, 358, 358, 365, 365, 377, 377, 366, 366, 155, 155, 80, 80, 112, 80, 80, 30
        };
